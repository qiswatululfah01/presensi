...
<div class="form-group p-4">
              <table border="0" width="100%">
                  <tr>
                      ...
                      <td width="10%"></td>
                      <td width="10%"></td>
                      <td width="10%"><label for="nama_siswa">Pembina</label></td>
                      <td width="30%" colspan="3"><input type="text" class="form-control" name="nta" value="{{old('nta')}}"></td>
                  </tr>

                  <tr>
                      <td width="10%"><label for="nta">Tanggal</label></td>
                      <td width="30%" colspan="3"><input type="date" class="form-control" name="nta" value="{{old('nta')}}"></td>
                      <td width="10%"></td>
                      <td width="10%"></td>
                      <td><label for="nama_siswa">Sertifikat</label></td>
                      <td>
...
<br>
<div class="card-body">
  <p class="text-uppercase text-center"><strong>KEGIATAN PRAMUKA</strong></p>
...
<table class="table table-bordered" width="100%">
  <thead>
    <tr>
      ...
      <th scope="col" width="30%">Nama Kegiatan</th>
