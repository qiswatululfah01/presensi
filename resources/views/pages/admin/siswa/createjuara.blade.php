...
<div class="form-group p-4">
              <table border="0" width="100%">
                  <tr>
                      <td width="10%"><label for="nta">Nama Lomba</label></td>
                      <td width="30%" colspan="3"><input type="text" class="form-control" name="nta" value="{{old('nta')}}"></td>
                      <td width="10%"></td>
                      <td width="10%"></td>
                      <td width="10%"><label for="nama_siswa">Juara</label></td>
                      <td width="30%">
                      <select class="custom-select my-1 mr-sm-2" id="jenis_kelamin" name="jenis_kelamin">
                          <option selected>Pilih...</option>
                          <option value="Laki-laki">Juara I</option>
                          <option value="Perempuan">Juara II</option>
                          <option value="Laninya">Juara III</option>
                          <option value="Laninya">Harapan I</option>
                          <option value="Laninya">Harapan II</option>
                          <option value="Laninya">Harapan III</option>
                      </select>
                      </td>
                  </tr>

                  <tr>
                      <td width="10%"><label for="nta">Tingkat<label class="text-danger">*</label></label></td>
                      <td width="30%" colspan="3">
                      <select class="custom-select my-1 mr-sm-2" id="jenis_kelamin" name="jenis_kelamin">
                          <option selected>Pilih...</option>
                          <option value="Laki-laki">Provinsi</option>
                          <option value="Perempuan">Kota/ Kabupaten</option>
                          <option value="Laninya">Kecamatan</option>
                  ...
                  <tr>
                  <td width="10%"><label for="nama_siswa">Tahun</label></td>
                      <td width="30%" colspan="3"><input type="text" class="form-control" name="nta" value="{{old('nta')}}"></td>
                      <td width="10%"></td>
                      <td width="10%"></td> 
                      <td width="10%"></td>
...
<br>
<div class="card-body">
  <p class="text-uppercase text-center"><strong>RIWAYAT KEJUARAAN</strong></p>
...
<table class="table table-bordered" width="100%">
  <thead>
    <tr>
      ...
      <th scope="col" width="35%">Nama Lomba</th>
      <th scope="col" width="15%">Tingkat</th>
